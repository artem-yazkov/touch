...
int main(int argc,char **argv)
{
   ...
   /* Draw a second line (normal to the first) as a point array */
   xcolour.red = 32000; xcolour.green = 64000; xcolour.blue = 32000;
   xcolour.flags = DoRed | DoGreen | DoBlue;
   for (i=10; i<390; i++)
   {
      xcolour.red = 32000 + i*80;
      xcolour.green = 64000 - i*80;
      XAllocColor(thedisplay,thecolormap,&xcolour);
      XSetForeground(thedisplay,thecontext,xcolour.pixel);
      XDrawPoint(thedisplay,thewindow,thecontext, i, 400 - i);
   }
   sleep(2);
